      ...
      {/* margin top */}
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
                  ...
                  <CardContent>
                    <div className="grid gap-6 mt-2">
                      ...
                      <div className="grid gap-3">
                        ...
                        <Input id="name" placeholder="Ex: McDonald's" />
                      </div>
                      <div className="grid gap-3">
                      ...
                      <div className="grid gap-3">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="domicile">Restaurant</SelectItem>
                            <SelectItem value="exterieur">Station essence</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                ...
                >
                  <CardHeader>
                    <CardTitle>Image de l'activité</CardTitle>
                  </CardHeader>
                  <Separator className="mb-8" />
                  <CardContent>
